...
class FaithfulnessCalculator(MetricCalculator):
    ...
    3. Deterministic claim-containment fallback (LLM-free).
    """
    ...
    def _try_ragas_evaluation(self, metric_input: MetricInput) -> Optional[float]:
        ...
        try:
            ...
            if evaluator.is_circuit_open():
                logger.info("RAGAS circuit breaker OPEN (429 rate limit). Using deterministic fallback for faithfulness.")
                return None
